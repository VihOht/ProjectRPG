...
interface CharacterPsycDescProps {
    psycDesc: string;
    handlePsycDescChange: (value: string) => void;
    update: () => void;
}

export function CharacterPsycDesc({
    psycDesc,
    handlePsycDescChange,
    update,
}: CharacterPsycDescProps) {
        ...
        <section className="mb-8">
            ...
            {isEditing ? (
                ...
                <p className="text-vaccineGray-300 whitespace-pre-line">
                    {psycDesc || "Nenhuma descrição adicionada."}
                </p>
            )}
        </section>
    );

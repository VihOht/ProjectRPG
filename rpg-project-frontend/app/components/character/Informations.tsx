    ...
    return (
        <section className="mb-8">
                    <div className="itens-center flex justify-between mb-4">
                        <h2 className="text-3xl font-walthari font-semibold mb-4 text-vaccineRed">
                            Informações Básicas
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full font-trajanPRegular bg-vaccineBlueTones-900 px-3 py-2 ${isEditing ? 'border-gray-400 border' : ''} rounded-md focus:outline-none focus:ring-2 focus:ring-vaccineRed text-white`}
                                disabled={!isEditing}
                            >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full font-trajanPRegular bg-vaccineGray-300 px-3 py-2 ${isEditing ? 'border border-gray-400' : ''} rounded-md focus:outline-none focus:ring-2 focus:ring-vaccineRed`}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full font-trajanPRegular bg-vaccineGray-300 px-3 py-2 ${isEditing ? 'border-gray-400 border' : ''} rounded-md focus:outline-none focus:ring-2 focus:ring-vaccineRed`}
                                disabled={!isEditing}
                            >

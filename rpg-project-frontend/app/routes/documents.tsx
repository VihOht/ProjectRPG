...
import { LoreTab } from "../components/documents/tabs/LoreTab";
            ...
            <div className="container mx-auto py-8 w-wide">
                <Tabs defaultValue="classes" className="w-full">
                    <TabsList className="bg-vaccineGray-800/20 min-h-[40px] rounded-md w-full p-1 mb-6">
                        ...
                        <TabsTrigger value="lore" className="data-[state=active]:bg-vaccinePurple data-[state=active]:text-white text-vaccineGray-300 hover:text-vaccinePurple text-sm font-medium px-2 md:px-3 py-2 rounded-md">
                            Lore
                        </TabsTrigger>
                    </TabsList>
